    ...
    <>
      <div className="space-y-8">
        {categories.map((category, i) => {
          ...
          return (
            <ScrollReveal key={category.slug} delay={i * 0.08}>
              <div className="rounded-2xl border border-[rgba(var(--ink-rgb),0.06)] bg-white/80 overflow-hidden transition-all duration-500">
